...
int main()
{
    ...
    cout << "Path exists between 2 to 3: " << g.hasPathBFS(1, 3) << endl;
    cout << "Path exists between 3 to 2: " << g.hasPathBFS(2, 4) << endl;
    cout << "Path exists between 3 to 3: " << g.hasPathBFS(3, 3) << endl;

    g.reset();
    cout << "Path exists between 2 to 3: " << g.hasPathRecursive(1, 3) << endl;
    cout << "Path exists between 3 to 2: " << g.hasPathRecursive(2, 4) << endl;
    cout << "Path exists between 3 to 3: " << g.hasPathRecursive(3, 3) << endl;

    cout << "Path exists between 2 to 3: " << g.hasPath(1, 3) << endl;
    cout << "Path exists between 3 to 2: " << g.hasPath(2, 4) << endl;
    cout << "Path exists between 3 to 3: " << g.hasPath(3, 3) << endl;
